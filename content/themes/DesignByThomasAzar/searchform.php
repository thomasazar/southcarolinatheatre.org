<form action="/" method="get" class="search-form">
    ...
    <label for="search">Search on SCTA</label>
    <input type="text" name="s" id="search" value="<?php the_search_query(); ?>" /><button class='search-submit' type='submit'>Search</button>
</form>
