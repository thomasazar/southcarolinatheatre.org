<header class="banner">
    <div class='banner__bar'>
        <a class="banner__logo ui-link" href='/' title='Return to home page'>
            <img src="<?= get_stylesheet_directory_uri() . '/dist/images/scta-logo.jpg'; ?>" />
        </a>
    </div>
    <div class='banner__bar desktop-only'>
        <section class='banner__social'>
            <a class="ui-link" href='http://www.facebook.com/SCTheatreAssoc?fref=ts'>
            ...
            <a class="ui-link" href='http://www.twitter.com/SCTheatreAssoc'>
            ...
            <!-- Removed
            <a class="ui-link" href='https://plus.google.com/107479692152474137975/posts'>
